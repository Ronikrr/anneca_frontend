...
//     {
//         name: "Girls",
//         to: "/ourcollection/girls"
//     },
//     {
//         name: "Boys",
//         to: "/ourcollection/boys"
//     },
//     {
//         name: "Twinning Sets",
//         to: "/ourcollection/twinning set"
//     },
...
//         setIsLoading(true);
//         try {
//             const response = await axios.get("https://anneca-backend.onrender.com/api/v1/auth/logout", {
...
//                                     {
//                                         user == null ? null : <li><Link to={"/profile"} className="dropdown-item">Profile Edit</Link></li>
//                                     }
//                                     <li><Link to={"/login"} className="dropdown-item">Login & Security</Link></li>
//                                     {
//                                         user == null ? null : <li className="dropdown-item" onClick={handleLogout}>Logout</li>
//                                     }
//                                 </ul>
//                             </div>
...
//                                 <span className="cart_message position-absolute start-100 translate-middle border border-light rounded-circle">
//                                     <span>{wishlist?.items && wishlist?.items?.length > 0 ? wishlist?.items?.length : 0}</span>
//                                 </span>
//                             </Link>
//                         </div>
...
//                                         console.log("🚀 ~ handleLogout ~ event:", event.target)
...
//                                                     }
//                                                 }}
//                                                 // onMouseEnter={tab.name === "Girls" ? handleMouseEnter : () => { }}
//                                                 onMouseLeave={tab.name === "Girls" ? handleMouseLeave : () => { }}
//                                             >
//                                                 <Link
//                                                     className={`nav-link ${isGirlsActive ? 'text-primary' : 'text-dark'}`}
//                                                     to={tab.name !== "Girls" && tab.to}
...
//                                             <Link to={"/orders"} onClick={handleclose} className='nav-link' >Order History</Link>
//                                         </li>
//                                         {/* {
//                                             user == null ? null : <li className='w-100 nav-item py-2 ' ><Link to={"/profile"} className='nav-link' >Profile Edit</Link></li>
//                                         } */}
//                                         <li className='w-100 nav-item py-2' >
//                                             <Link to={`/contactus`} onClick={handleclose} className='nav-link' >Contact Us</Link>
//                                         </li>
//                                         <li className='w-100 nav-item py-2' >
//                                             <Link to={`/returnpolicy`} onClick={handleclose} className='nav-link' >Return & Refund</Link>
//                                         </li>
//                                         <li className='w-100 nav-item py-2' >
//                                             <Link to={`/shipping`} onClick={handleclose} className='nav-link' >Shipping Policy</Link>
//                                         </li>
//                                         <li className='w-100 nav-item py-2 ' >
//                                             <Link to={"/login"} onClick={handleclose} className='nav-link' >Login & Security</Link>
//                                         </li>
//                                         {
//                                             user == null ? null : <li onClick={handleclose} className='w-100 nav-item py-2 ' ><Link onClick={handleLogout} className='nav-link' >Logout</Link></li>
//                                         }
//                                     </ul>
//                                 </div>
...
//                                     <i className="bi bi-heart text-dark fs-5" style={{ marginBottom: '2px' }}></i>
//                                     <span className="cart_message position-absolute start-100 translate-middle border border-light rounded-circle">
//                                         <span className="cart_text" style={{}}>{wishlist?.items && wishlist?.items?.length > 0 ? wishlist?.items?.length : 0}</span>
//                                     </span>
//                                 </Link>
//                             </div>
//                         </div>
